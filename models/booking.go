...
type PlayBooking struct {
	...
	// Payment tracking
	PaymentID      string        `json:"payment_id" firestore:"payment_id"`
	PaymentGateway string        `json:"payment_gateway" firestore:"payment_gateway"`
	PaymentAmount  float64       `json:"payment_amount" firestore:"payment_amount"`
